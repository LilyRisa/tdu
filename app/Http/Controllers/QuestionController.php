...
class questionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('exam.makequestion_create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($qustionCount < $selectLenth ) {
            ...
            return view('exam.makequestion_index',['uniqueid' =>$uniqueId]);
    ...
    public function edit($id)
    {
        ...
        if (isset($_GET['submitFromEditPage'])) {
            ...
            return view('exam.makequestion_editone')->with('questions',$selectAll);
        }else{
        ...
        return view('exam.makequestion_edit')->with('questions',$selectQuestions);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return view('exam.makequestion_edit')->with('questions',$selectQuestions)->with('success', 'update success');
    }
