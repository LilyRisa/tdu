...
class ResultController extends Controller
{
    ...
    public function create(Request $var)
    {
        ...
        return view('exam.result_showall')->with('answeredQuestion',$answeredQuestion)->with('getScore',$getScore)->with('studentId',$getId)->with('course',$getCourseName);
